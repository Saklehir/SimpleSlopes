...
slopePlot <- function(
  ...
  ## Create intercepts
  i.Slope1 <- coef.int + HighMod1*coef.mod1 + HighMod2*coef.mod2 + HighMod1*HighMod2*coef.xvarmod1mod2
  i.Slope2 <- coef.int + HighMod1*coef.mod1 + LowMod2*coef.mod2 + HighMod1*LowMod2*coef.xvarmod1mod2
  i.Slope3 <- coef.int + LowMod1*coef.mod1 + HighMod2*coef.mod2 + LowMod1*HighMod2*coef.xvarmod1mod2
  i.Slope4 <- coef.int + LowMod1*coef.mod1 + LowMod2*coef.mod2 + LowMod1*LowMod2*coef.xvarmod1mod2
